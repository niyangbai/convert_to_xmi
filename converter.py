        ...
        for row in f:
            ...
            for entity in data["relations"]:
                ...
                if entity["head_span"]["start"] not in d.keys():
                    ...
                    goverbor = d[entity["head_span"]["start"]]
                ...
                cas_relation = SemanticRelations(begin=entity["child_span"]["start"], end=entity["child_span"]["end"], Dependent=dependent, Governor=goverbor, Relation=entity["label"])
